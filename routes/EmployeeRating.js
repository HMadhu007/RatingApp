...
debugger
  ...
  var sql = `INSERT INTO employee_rating (UniqueId, Employee_Id, Employee_Name, Review_Date, Employee_Job_knowledge, Employee_Work_Quality, Employee_Attendence_punctuality, Employee_Productivity, Employee_Communication, Employee_Behaviour, Employee_Total_Rating, Employee_Overall_Feedback, Reviewer_Id, Table_Id) 
  VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?)`;

  
  connection.query(sql, [UniqueId, Employee_Id, Emp_name, Review_Date, Job_Knowladge, Work_Quality, Attendance_Punctuality, Productivity, Communication_listening_Skill, Behaviour, Overall_Ratings, Overall_Feedback, Reviewer_Id, Reviewer_Id+Employee_Id], function(error, data, rows){
debugger
    if(error) 
    {
      debugger
