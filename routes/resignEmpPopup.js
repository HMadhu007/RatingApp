...
router.get('/', function(req, res, next) {
    ...
    connection.query(sqlData,function(error,data){
      ...
      else
      {
        ...
        employeeeStatus= "Notic Period"
        employeeMockTaken= data[0].Employee_Mock_Taken
        employeeMockGiven= data[0].Employee_Mock_Given
        connection.query(insertData,[id,employeeName,employeeDesignation,employeeEmail,employeeDept,employeePassword,employeeIcon,employeeeStatus,employeeMockTaken,employeeMockGiven],function(error, data, rows){
          if(error) 
          {
            debugger
