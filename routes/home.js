...
debugger
  ...
  if(EmpId && EmpPass){
debugger
        var query = `SELECT * FROM employee_table WHERE Employee_Id = ${EmpId}`;
        
        connection.query(query, function(error, data){
            debugger
            if(EmpId == "Admin" && EmpPass == "12345"){
                debugger
            ...
            else if(data.length > 0)
            {
                ...
                // res.redirect('/admin')
                    ...
                    else if(data[count].Employee_Password ==  EmpPass)
                    {
                        debugger
                        req.session.EmpId = data[count].Employee_Id
            ...
            else
            {
                ...
                req.flash('success',"Incorrect Id")
                res.redirect('home')
                // res.redirect('/home')
